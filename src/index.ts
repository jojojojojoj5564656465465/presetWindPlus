    ...
    rules: [
      ...
      [
        ...
        (match) => {
          ...
          const returnDirection: UnionValueDictionary<typeof combination> =
      ...
      [
        ...
        (match) => {
          ...
          eliminerUndefined(
            direction,
            "(?:p|m)(?:x|y)|gap) direction is undefined"
          );
          const returnDirection: UnionValueDictionary<typeof combination> =
            combination[direction];
      ...
      [
        ...
        >[] => {
          ...
          const resultFunction = (
            x: keyof typeof dictionary
          ): UnionValueDictionary<typeof dictionary> => dictionary[x];
